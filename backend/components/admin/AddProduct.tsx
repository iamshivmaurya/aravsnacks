  ...
  return (
    <div className="p-6 space-y-6">
      ...
      >
        ...
        {/* Pricing */}
        <section className="pt-4">
          <h3 className="text-lg font-semibold text-gray-700 mb-3">💰 Pricing & Discounts</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
        ...
        {/* Inventory */}
        <section className="pt-4">
          <h3 className="text-lg font-semibold text-gray-700 mb-3">📦 Inventory & Tax</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, tax_class_id: Number(e.target.value) })}
                className="border p-2 rounded w-full"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, product_weight: Number(e.target.value) })}
                className="border p-2 rounded w-full"
        ...
        {/* Image */}
        <section className="pt-4">
          <h3 className="text-lg font-semibold text-gray-700 mb-3">🖼️ Media</h3>
          <div>
        ...
        {/* Description & Active */}
        <section className="pt-4">
          <h3 className="text-lg font-semibold text-gray-700 mb-3">📝 Description & Status</h3>
          <div>
        ...
        <div className="pt-4">
          <button
            type="submit"
            disabled={loading}
            className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-lg flex items-center gap-2 transition"
          >
