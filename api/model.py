...
class ProductTracking(Base):
    ...
    order_received_time = Column(DateTime, default=datetime.now)
    order_packed_time = Column(DateTime, nullable=True)
    order_shipped_time = Column(DateTime, nullable=True)
    on_the_way_time = Column(DateTime, nullable=True)
    order_arrived_time = Column(DateTime, nullable=True)
    order_delivered_time = Column(DateTime, nullable=True)

    current_status = Column(String(50), default="Order Received")
